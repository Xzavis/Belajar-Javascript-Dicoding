...
const sampleProducts = [
  ...
  function getProductsByCategory(products, category) {
     ...
     */
    return products.filter(checkCategoryProduct => checkCategoryProduct.category === category);
  }
  ...
  function findProductById(products, id) {
     ...
     */
    return products.find((checkID) => checkID.id == id)
  }
  ...
  function applyDiscount(products, discount) {
     ...
     */
    return products.map((checkDiscount) => ({...checkDiscount, price: checkDiscount.price - checkDiscount.price * (discount/100)} ))
  }
